...
pub fn calculate_accuracy(beatmap: &structs::Beatmap) -> f64 {
    ...
    let cert: f64 = 0.1;
    let mut ss_ur: f64 = (5.0 * f64::sqrt(2.0) * calculation_utils::od_to_ms(beatmap.od)) / erf_inv(f64::powf(cert, 1.0 / circles));
    ...
    let accuracy: f64 = total_mult * f64::powf(f64::powf(beatmap.skills.stamina, ver_scale) / ss_ur, total_pow);
