...
pub fn calculate_classic_precision(beatmap: &structs::Beatmap) -> f64 {
    ...
    if beatmap.skills.agility > agility_limit {
        ...
        scaled_agility = f64::powf(beatmap.skills.agility + 1.0, agility_pow) - agility_subtract;
    }

    let agility: f64 = total_mult * f64::powf(scaled_agility * beatmap.cs, total_pow);
